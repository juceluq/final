...
@switch($type)
    ...
    @case('success')
        @php $class = 'text-green-800 bg-green-50 dark:bg-gray-800 dark:text-green-400' @endphp
    @break

    @case('warning')
        @php $class = 'text-yellow-800 bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400' @endphp
    @break

    @case('dark')
        @php $class = 'text-gray-800 bg-gray-50 dark:bg-gray-800 dark:text-gray-400' @endphp
    @break
