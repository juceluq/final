    ...
    <div class="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-lg max-w-md w-full">
        <form action="/register" method="POST">
            ...
            <div class="mb-4">
                ...
                <select id="role" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
